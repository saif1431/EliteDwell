  ...
  return (
    <div className='mt-4 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col items-center justify-center mt-4 gap-4'>
        <img className='w-24 h-24 rounded-full object-cover ' src={currentUser.avatar} alt="" />
        <input className='p-3 border border-slate-400 w-full outline-none rounded-lg' type="text" placeholder='userName' id='userName' />
        <input className='p-3 border border-slate-400 w-full outline-none rounded-lg' type="text" placeholder='Email' id='email' />
