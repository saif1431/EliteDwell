    ...
    <div className='flex items-center justify-center mt-14 flex-col'>
      ...
      <div className='bg-gray-100 p-4 rounded-md mt-4 w-96'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-1'>
          <label className='text-slate-800 font-semibold' htmlFor='userName'>userName <sup className='text-red-600 text-lg'>*</sup></label>
          <input className='py-2 border border-slate-300 mt-2 rounded-lg outline-none px-4' type='text' id='userName' name='userName' placeholder='Enter your userName' onChange={handleChange} />
